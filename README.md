...
|---------|-------|-------------|
| Inflammatory–Regulatory coupling | ρ = 0.94, R² = 0.95 | P = 1.7 × 10⁻¹⁹ |
| Coupling slope | 1.06 | Near-perfect 1:1 scaling |
| Regulatory residual vs PASI | ρ = 0.47 | P = 0.023 |
| Raw inflammatory vs PASI | ρ = 0.04 | P = 0.86 (n.s.) |
...
**(a)** DEJ axis on tissue coordinates. **(b)** 1D regulon field profiles with 95% bootstrap CIs. **(c)** Inflammatory–regulatory coupling (R² = 0.95) and disease phase space. **(d)** Regulatory residual predicts PASI (ρ = 0.47).
...
Full data, scripts, and figures: [Zenodo archive](https://doi.org/10.5281/zenodo.XXXXXXX)
